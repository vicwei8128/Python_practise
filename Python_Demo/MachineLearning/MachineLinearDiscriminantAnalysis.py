...
classifier = LinearDiscriminantAnalysis(n_components=None, priors=None, shrinkage=None, solver='svd', store_covariance=False, tol=0.0001)
...
#save model
joblib.dump(classifier, "titanic_LinearDiscriminantAnalysis_model", compress=9)
