#Grid search hyperparameter tuning with scikit-learn ( GridSearchCV ):https://www.pyimagesearch.com/2021/05/24/grid-search-hyperparameter-tuning-with-scikit-learn-gridsearchcv/
...
ap.add_argument("-d", "--dataset", default="texture_dataset", help="path to input dataset")
